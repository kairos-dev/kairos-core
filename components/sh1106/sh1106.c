...
/*
	Teste Function
 */
void task_test_SSD1306i2c(void *pvParameters) {
    u8g2_esp32_hal_t u8g2_esp32_hal = U8G2_ESP32_HAL_DEFAULT;
    u8g2_esp32_hal.sda   = (uint8_t)PIN_SDA;
    u8g2_esp32_hal.scl  = (uint8_t)PIN_SCL;
    u8g2_esp32_hal_init(u8g2_esp32_hal);
    u8g2_t u8g2; // a structure which will contain all the data for one display
    u8g2_Setup_sh1106_i2c_128x64_winstar_f( //U8G2_SH1106_128X64_NONAME_F_HW_I2C
        &u8g2,
        U8G2_R2,
        //u8x8_byte_sw_i2c,
    ...
    ESP_LOGI(TAG, "Teste Inicializado.");
    u8g2_InitDisplay(&u8g2); // send init sequence to the display, display is in sleep mode after this,
    ESP_LOGI(TAG, "Acordando Display - OK");
    u8g2_SetPowerSave(&u8g2, 0); // wake up display
    ESP_LOGI(TAG, "Limpando Buffer - OK");
    u8g2_ClearBuffer(&u8g2);
    ESP_LOGI(TAG, "Configurando Fonte - OK");
    u8g2_SetFont(&u8g2, u8g2_font_t0_12b_mf);
    ESP_LOGI(TAG, "Escrevendo no Display - OK");
    u8g2_DrawStr(&u8g2, 30,30,"Test Passed!");
    ESP_LOGI(TAG, "Enviando Buffer - OK");
